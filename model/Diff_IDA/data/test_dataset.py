...
class Dark_Dataset(Dataset):
    def __init__(self, dataroot, resolution=256, split='train', data_len=20):
        ...
        self.R_ref_path = Util.get_paths_from_images('{}/low'.format(dataroot)) #not use for this version
        self.gt_path = Util.get_paths_from_images('{}/high'.format(dataroot)) #not use for this version
